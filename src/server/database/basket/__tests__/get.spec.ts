...
const { getOrderForCustomer, userHasOrder, orderHasMomentAdded } = require('..')
...
describe('Get order tests', () => {
  ...
  it('should verify that the user can access the order', async () => {
    const customerId = Types.ObjectId('1cfc2370562b178fdfa1be91')
  ...
  it('should verify that the user cannot access the order', async () => {
  ...
  it('should verify that the moment has not already been added to the order', async () => {
    const customerId = Types.ObjectId('1cfc2370562b178fdfa1be91')
    const orderId = Types.ObjectId('9aaa2370562a178fdfa1ae99')
  ...
  it('should verify that the moment has already been added to the order', async () => {
    const customerId = Types.ObjectId('1cfc2370562b178fdfa1be91')
    const orderId = Types.ObjectId('9aaa2370562a178fdfa1ae99')
  ...
  it('should verify that the order is verified before checking if moment has been added', async () => {
